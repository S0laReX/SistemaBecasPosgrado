--------------------------------------------------------
--  File created - Wednesday-September-09-2026   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Type T_ACADEMICO
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TYPE "SYSTEM"."T_ACADEMICO" AS OBJECT (
...
--------------------------------------------------------
--  DDL for Type T_CURSO
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TYPE "SYSTEM"."T_CURSO" AS OBJECT (
    id_curso NUMBER,
    nombre_curso VARCHAR2(100),
    creditos NUMBER
);
--------------------------------------------------------
--  DDL for Type T_DIRECCION
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TYPE "SYSTEM"."T_DIRECCION" AS OBJECT (
    pais VARCHAR2(50),
...
--------------------------------------------------------
--  DDL for Type T_EXPERIENCIA
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TYPE "SYSTEM"."T_EXPERIENCIA" AS OBJECT (
...
--------------------------------------------------------
--  DDL for Type T_EXPLABORAL
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TYPE "SYSTEM"."T_EXPLABORAL" AS OBJECT (
    empresa VARCHAR2(100),
    cargo VARCHAR2(100),
...
--------------------------------------------------------
--  DDL for Type T_LABORAL
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TYPE "SYSTEM"."T_LABORAL" AS OBJECT (
...
--------------------------------------------------------
--  DDL for Type T_LISTAEXPLABORAL
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TYPE "SYSTEM"."T_LISTAEXPLABORAL" AS TABLE OF T_ExpLaboral;
--------------------------------------------------------
--  DDL for Type T_LISTA_ACADEMICOS
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TYPE "SYSTEM"."T_LISTA_ACADEMICOS" AS TABLE OF t_academico;
--------------------------------------------------------
--  DDL for Type T_LISTA_CURSOS
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TYPE "SYSTEM"."T_LISTA_CURSOS" AS TABLE OF t_curso;
--------------------------------------------------------
--  DDL for Type T_LISTA_LABORALES
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TYPE "SYSTEM"."T_LISTA_LABORALES" AS TABLE OF t_laboral;
--------------------------------------------------------
--  DDL for Type T_NT_EXPERIENCIA
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TYPE "SYSTEM"."T_NT_EXPERIENCIA" AS TABLE OF t_experiencia;
--------------------------------------------------------
--  DDL for Type T_OFERTA
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TYPE "SYSTEM"."T_OFERTA" AS OBJECT (
    id_oferta NUMBER,
...
--------------------------------------------------------
--  DDL for Type T_POSTULANTE
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TYPE "SYSTEM"."T_POSTULANTE" AS OBJECT (
...
--------------------------------------------------------
--  DDL for Type T_PROGRAMA
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TYPE "SYSTEM"."T_PROGRAMA" AS OBJECT (
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE TYPE "SYSTEM"."T_SEDE" AS OBJECT (
...
--------------------------------------------------------
--  DDL for Type T_SOLICITUD
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TYPE "SYSTEM"."T_SOLICITUD" AS OBJECT (
    id_solicitud NUMBER,
...
--------------------------------------------------------
--  DDL for Type T_UNIVERSIDAD
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TYPE "SYSTEM"."T_UNIVERSIDAD" AS OBJECT (
...
--------------------------------------------------------
--  DDL for Sequence SEQ_OFERTA
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."SEQ_OFERTA"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
--------------------------------------------------------
--  DDL for Sequence SEQ_POSTULACION
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."SEQ_POSTULACION"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
--------------------------------------------------------
--  DDL for Sequence SEQ_POSTULANTE
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."SEQ_POSTULANTE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
--------------------------------------------------------
--  DDL for Sequence SEQ_PROG
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."SEQ_PROG"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
--------------------------------------------------------
--  DDL for Sequence SEQ_SEDE
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."SEQ_SEDE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
--------------------------------------------------------
--  DDL for Sequence SEQ_UNIV
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."SEQ_UNIV"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."OFERTAS" OF "SYSTEM"."T_OFERTA" 
...
--------------------------------------------------------
--  DDL for Table POSTULANTES
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."POSTULANTES" OF "SYSTEM"."T_POSTULANTE" 
...
--------------------------------------------------------
--  DDL for Table PROGRAMAS
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."PROGRAMAS" OF "SYSTEM"."T_PROGRAMA" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."SEDES" OF "SYSTEM"."T_SEDE" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."SOLICITUDES" OF "SYSTEM"."T_SOLICITUD" 
 ...
 NOCOMPRESS LOGGING
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" 
 LOB ("RESUMEN_INTERES") STORE AS BASICFILE (
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM"
--------------------------------------------------------
--  DDL for Table UNIVERSIDADES
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."UNIVERSIDADES" OF "SYSTEM"."T_UNIVERSIDAD" 
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.OFERTAS
SET DEFINE OFF;
Insert into SYSTEM.OFERTAS (ID_OFERTA,REF_PROGRAMA,FECHA_INICIO,FECHA_FIN,TIPO_FINANCIAMIENTO,ESTADO_OFERTA) values (101,'SYSTEM.T_PROGRAMA(''PRG-001'', ''Maestría en Ingeniería de Sistemas'', ''Postgrado en arquitectura de software y BD'', ''Tecnología'', ''Maestría'', ''Presencial'', ''oracle.sql.REF@e7e745b3'')',to_date('01-FEB-27','DD-MON-RR'),to_date('01-DEC-28','DD-MON-RR'),'Autofinanciado','Vigente');
Insert into SYSTEM.OFERTAS (ID_OFERTA,REF_PROGRAMA,FECHA_INICIO,FECHA_FIN,TIPO_FINANCIAMIENTO,ESTADO_OFERTA) values (102,'SYSTEM.T_PROGRAMA(''PRG-002'', ''Especialidad en IoT y Hardware'', ''Desarrollo con ESP32, sensores y protocolos'', ''Tecnología'', ''Especialidad'', ''Virtual'', ''oracle.sql.REF@e7e745b3'')',to_date('01-MAR-27','DD-MON-RR'),to_date('01-OCT-27','DD-MON-RR'),'Beca Completa','Vigente');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.POSTULANTES
SET DEFINE OFF;
Insert into SYSTEM.POSTULANTES (DOC_IDENTIDAD,NOMBRES,APELLIDOS,CORREO,NIVEL_FORMACION,EXPERIENCIAS) values ('1234567','Carlos','Mendoza','carlos.m@email.com','Ingeniero de Sistemas',SYSTEM.T_NT_EXPERIENCIA(SYSTEM.T_EXPERIENCIA('Tech Solutions SRL', 'Desarrollador C# y WPF', '2024-01-01 00:00:00.0', '2025-12-31 00:00:00.0'), SYSTEM.T_EXPERIENCIA('Proyecto de Transporte', 'Líder de Proyecto IoT', '2026-01-01 00:00:00.0', NULL)));
Insert into SYSTEM.POSTULANTES (DOC_IDENTIDAD,NOMBRES,APELLIDOS,CORREO,NIVEL_FORMACION,EXPERIENCIAS) values ('7654321','Lucia','Villarroel','lucia.v@email.com','Ingeniera de Software',SYSTEM.T_NT_EXPERIENCIA(SYSTEM.T_EXPERIENCIA('Agencia Web', 'Programadora PHP y SQL', '2023-03-15 00:00:00.0', '2026-08-30 00:00:00.0')));
REM INSERTING into SYSTEM.PROGRAMAS
SET DEFINE OFF;
Insert into SYSTEM.PROGRAMAS (COD_PROGRAMA,NOMBRE,DESCRIPCION,AREA,TIPO_PROGRAMA,MODALIDAD,REF_UNIVERSIDAD) values ('PRG-001','Maestría en Ingeniería de Sistemas','Postgrado en arquitectura de software y BD','Tecnología','Maestría','Presencial','SYSTEM.T_UNIVERSIDAD(1, ''Universidad Mayor de San Simón'', ''Bolivia'', ''Cochabamba'', ''Campus Central Las Cuadras'', ''4123456'')');
Insert into SYSTEM.PROGRAMAS (COD_PROGRAMA,NOMBRE,DESCRIPCION,AREA,TIPO_PROGRAMA,MODALIDAD,REF_UNIVERSIDAD) values ('PRG-002','Especialidad en IoT y Hardware','Desarrollo con ESP32, sensores y protocolos','Tecnología','Especialidad','Virtual','SYSTEM.T_UNIVERSIDAD(1, ''Universidad Mayor de San Simón'', ''Bolivia'', ''Cochabamba'', ''Campus Central Las Cuadras'', ''4123456'')');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.SEDES
SET DEFINE OFF;
Insert into SYSTEM.SEDES (COD_SEDE,NOMBRE,TIPO_SEDE,RESPONSABLE,PAIS,DEPARTAMENTO,MUNICIPIO,DIRECCION) values ('SED-CBB-01','Campus Central Las Cuadras','Principal','Ing. Roberto Mendoza','Bolivia','Cochabamba','Cochabamba','Av. Sucre y Parque La Torre');
Insert into SYSTEM.SEDES (COD_SEDE,NOMBRE,TIPO_SEDE,RESPONSABLE,PAIS,DEPARTAMENTO,MUNICIPIO,DIRECCION) values ('SED-CBB-02','Sede Tecnológica Quillacollo','Anexo','MSc. Patricia Vargas','Bolivia','Cochabamba','Quillacollo','Km 12 Carretera al Occidente');
Insert into SYSTEM.SEDES (COD_SEDE,NOMBRE,TIPO_SEDE,RESPONSABLE,PAIS,DEPARTAMENTO,MUNICIPIO,DIRECCION) values ('SED-LPZ-01','Edificio Central Postgrado','Principal','Dr. Fernando Alarcón','Bolivia','La Paz','La Paz','Av. 6 de Agosto esq. JJ Pérez');
REM INSERTING into SYSTEM.SOLICITUDES
SET DEFINE OFF;
Insert into SYSTEM.SOLICITUDES (ID_SOLICITUD,REF_POSTULANTE,REF_OFERTA,ESTADO) values (1,'SYSTEM.T_POSTULANTE(''1234567'', ''Carlos'', ''Mendoza'', ''carlos.m@email.com'', ''Ingeniero de Sistemas'', SYSTEM.T_NT_EXPERIENCIA(SYSTEM.T_EXPERIENCIA(''Tech Solutions SRL'', ''Desarrollador C# y WPF'', ''2024-01-01 00:00:00.0'', ''2025-12-31 00:00:00.0''), SYSTEM.T_EXPERIENCIA(''Proyecto de Transporte'', ''Líder de Proyecto IoT'', ''2026-01-01 00:00:00.0'', NULL)))','SYSTEM.T_OFERTA(101, ''oracle.sql.REF@d6b44904'', ''2027-02-01 00:00:00.0'', ''2028-12-01 00:00:00.0'', ''Autofinanciado'', ''Vigente'')','Aceptada');
Insert into SYSTEM.SOLICITUDES (ID_SOLICITUD,REF_POSTULANTE,REF_OFERTA,ESTADO) values (2,'SYSTEM.T_POSTULANTE(''1234567'', ''Carlos'', ''Mendoza'', ''carlos.m@email.com'', ''Ingeniero de Sistemas'', SYSTEM.T_NT_EXPERIENCIA(SYSTEM.T_EXPERIENCIA(''Tech Solutions SRL'', ''Desarrollador C# y WPF'', ''2024-01-01 00:00:00.0'', ''2025-12-31 00:00:00.0''), SYSTEM.T_EXPERIENCIA(''Proyecto de Transporte'', ''Líder de Proyecto IoT'', ''2026-01-01 00:00:00.0'', NULL)))','SYSTEM.T_OFERTA(102, ''oracle.sql.REF@47764017'', ''2027-03-01 00:00:00.0'', ''2027-10-01 00:00:00.0'', ''Beca Completa'', ''Vigente'')','Aceptada');
Insert into SYSTEM.SOLICITUDES (ID_SOLICITUD,REF_POSTULANTE,REF_OFERTA,ESTADO) values (3,'SYSTEM.T_POSTULANTE(''7654321'', ''Lucia'', ''Villarroel'', ''lucia.v@email.com'', ''Ingeniera de Software'', SYSTEM.T_NT_EXPERIENCIA(SYSTEM.T_EXPERIENCIA(''Agencia Web'', ''Programadora PHP y SQL'', ''2023-03-15 00:00:00.0'', ''2026-08-30 00:00:00.0'')))','SYSTEM.T_OFERTA(101, ''oracle.sql.REF@d6b44904'', ''2027-02-01 00:00:00.0'', ''2028-12-01 00:00:00.0'', ''Autofinanciado'', ''Vigente'')','Pendiente');
Insert into SYSTEM.SOLICITUDES (ID_SOLICITUD,REF_POSTULANTE,REF_OFERTA,ESTADO) values (4,'SYSTEM.T_POSTULANTE(''1234567'', ''Carlos'', ''Mendoza'', ''carlos.m@email.com'', ''Ingeniero de Sistemas'', SYSTEM.T_NT_EXPERIENCIA(SYSTEM.T_EXPERIENCIA(''Tech Solutions SRL'', ''Desarrollador C# y WPF'', ''2024-01-01 00:00:00.0'', ''2025-12-31 00:00:00.0''), SYSTEM.T_EXPERIENCIA(''Proyecto de Transporte'', ''Líder de Proyecto IoT'', ''2026-01-01 00:00:00.0'', NULL)))','SYSTEM.T_OFERTA(101, ''oracle.sql.REF@d6b44904'', ''2027-02-01 00:00:00.0'', ''2028-12-01 00:00:00.0'', ''Autofinanciado'', ''Vigente'')','Pendiente');
REM INSERTING into SYSTEM.SQLPLUS_PRODUCT_PROFILE
SET DEFINE OFF;
REM INSERTING into SYSTEM.UNIVERSIDADES
SET DEFINE OFF;
Insert into SYSTEM.UNIVERSIDADES (ID_UNIVERSIDAD,NOMBRE,PAIS,CIUDAD,DIRECCION,TELEFONO) values (1,'Universidad Mayor de San Simón','Bolivia','Cochabamba','Campus Central Las Cuadras','4123456');
Insert into SYSTEM.UNIVERSIDADES (ID_UNIVERSIDAD,NOMBRE,PAIS,CIUDAD,DIRECCION,TELEFONO) values (2,'Universidad Mayor de San Andrés','Bolivia','La Paz','Av. Villazón','2123456');
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" NOCOMPRESS 
  ...
  TABLESPACE "SYSAUX" )
--------------------------------------------------------
--  DDL for Index SYS_FK0000077234N00008$
--------------------------------------------------------

  CREATE INDEX "SYSTEM"."SYS_FK0000077234N00008$" ON "SYSTEM"."NT_EXPERIENCIAS_TAB" ("NESTED_TABLE_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" NOCOMPRESS 
  ...
  TABLESPACE "SYSAUX" )
--------------------------------------------------------
--  DDL for Procedure SP_AGREGAR_EXPERIENCIA
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."SP_AGREGAR_EXPERIENCIA" (
    p_doc IN VARCHAR2, 
...
END;
--------------------------------------------------------
--  DDL for Procedure SP_CREAR_POSTULANTE
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."SP_CREAR_POSTULANTE" (
    p_doc IN VARCHAR2, 
...
END;
--------------------------------------------------------
--  DDL for Function FN_ACEPTAR_SOLICITUD
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."FN_ACEPTAR_SOLICITUD" (
...
END;
--------------------------------------------------------
--  DDL for Function FN_CONTAR_ACEPTADOS
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."FN_CONTAR_ACEPTADOS" (
...
END;
--------------------------------------------------------
--  DDL for Function FN_CREAR_OFERTA
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."FN_CREAR_OFERTA" (
...
END;
--------------------------------------------------------
--  DDL for Function FN_REGISTRAR_POSTULACION
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."FN_REGISTRAR_POSTULACION" (
...
END;
--------------------------------------------------------
--  DDL for Function FN_REGISTRAR_SOLICITUD
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "SYSTEM"."FN_REGISTRAR_SOLICITUD" (
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."SOLICITUDES" ADD PRIMARY KEY ("ID_SOLICITUD")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE
  ALTER TABLE "SYSTEM"."SOLICITUDES" ADD UNIQUE ("SYS_NC_OID$") RELY
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."POSTULANTES" ADD PRIMARY KEY ("DOC_IDENTIDAD")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE
  ALTER TABLE "SYSTEM"."POSTULANTES" ADD UNIQUE ("EXPERIENCIAS") RELY
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE
  ALTER TABLE "SYSTEM"."POSTULANTES" ADD UNIQUE ("SYS_NC_OID$") RELY
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."SEDES" ADD PRIMARY KEY ("COD_SEDE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE
  ALTER TABLE "SYSTEM"."SEDES" ADD UNIQUE ("SYS_NC_OID$") RELY
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PROGRAMAS" ADD PRIMARY KEY ("COD_PROGRAMA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE
  ALTER TABLE "SYSTEM"."PROGRAMAS" ADD UNIQUE ("SYS_NC_OID$") RELY
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."UNIVERSIDADES" ADD PRIMARY KEY ("ID_UNIVERSIDAD")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE
  ALTER TABLE "SYSTEM"."UNIVERSIDADES" ADD UNIQUE ("SYS_NC_OID$") RELY
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."OFERTAS" ADD PRIMARY KEY ("ID_OFERTA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE
  ALTER TABLE "SYSTEM"."OFERTAS" ADD UNIQUE ("SYS_NC_OID$") RELY
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
